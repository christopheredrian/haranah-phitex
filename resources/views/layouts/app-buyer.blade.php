        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class= {{ is_active(['/dashboard' ]) }}>
                    <a href="/buyer/buyer_profile/dashboard">
                        <i class="pe-7s-graph"></i>
                        <p>Dashboard</p>
                    </a>
                </li>
                <li data-toggle="collapse" data-target="#prof" class={{ is_active(['/profile' ]) }}>
                    <a href="#">
                ...
                <ul class="sub-menu collapse" id="prof">
                    <li class="{{ is_active(['/profile' ]) }}"><a href="/buyer/buyer_profile/profile"><i class="pe-7s-user"></i><p>View</p></a>
                    </li>
                    <li class="{{ is_active(['/edit' ]) }}"><a href="/buyer/buyer_profile/edit"><i class="pe-7s-user"></i><p>Edit</p></a>
                    </li>
                </ul>

                <li class= {{ is_active(['/events' ]) }}>
                    <a href="/buyer/buyer_profile/events">
