@if(Auth::user()->role == "superadmin")
    <div class="form-group">
        <label for="image" class="col-md-4 col-xs-4 control-label">Upload Profile Picture</label>
    ...
    <div class="form-group {{ $errors->has('address') ? 'has-error' : ''}}">
        <label for="address" class="col-md-4 col-xs-4 control-label">{{ 'Address' }}</label>
        <div class="col-md-6 col-xs-6">
            <input class="form-control" type="text" name="address" id="address"
                   value="{{ old('address', isset($buyer) ? $buyer->company_address : '') }}">
