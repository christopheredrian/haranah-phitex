        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Add Seller to Event</div>
                    <div class="panel-body">
                        ...
                        <form id="createForm" method="POST" action="{{ url('/admin/event-sellers') }}"
                        ...
                        <form id="fileExport" action="/verifyUsers" enctype="multipart/form-data"
                        method="POST"
