                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <div class="profile-user-image">
                                <img onerror=this.src="/img/default-logo.png" class="profile-user-img"
                                     src="/uploads/seller-{{ $seller->id }}.jpg" alt="User profile picture">
                            </div>
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="event">
                                ...
                                <div class="box box-solid">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        @else
                                            <input type="button" class="btn pull-right btn-primary"
                                                   onclick="location.href='/seller/pick/{{$sellerEvent->id}}';"
                                                   value="Select Buyers"/>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="edit">
                                <form method="POST" action="{{ url('/seller/submit')}}" accept-charset="UTF-8"
                                    ...
                                    <div class="form-group {{ $errors->has('company_logo') ? 'has-error' : ''}}">
                                        <label for="company_logo"
                                               class="col-md-4 control-label">{{ 'Company Logo' }}</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group {{ $errors->has('company_name') ? 'has-error' : ''}}">
                                        <label for="company_name"
                                               class="col-md-4 control-label">{{ 'Company Name' }}</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group {{ $errors->has('company_address') ? 'has-error' : ''}}">
                                        <label for="company_name"
                                               class="col-md-4 control-label">{{ 'Company Address' }}</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group {{ $errors->has('country') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" type="text" name="country" id="country">
                                                <option value="{{old('country', isset($seller) ? $seller->country : '')}}"
                                                        selected="selected"
                                                        style="display:none;">{{ old('country', isset($seller) ? $seller->country : '') }}</option>
                                        ...
                                        @else
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input style="cursor: pointer" disabled="disabled"
                                    ...
                                    <div class="form-group {{ $errors->has('event_rep1') ? 'has-error' : ''}}">
                                        <label for="event_rep1"
                                               class="col-md-4 control-label">{{ 'Event Representative 1' }}</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group {{ $errors->has('event_rep2') ? 'has-error' : ''}}">
                                        <label for="event_rep2"
                                               class="col-md-4 control-label">{{ 'Event Representative 2' }}</label>
                                        <div class="col-md-8">
                            ...
                            <div class="tab-pane" id="final-schedule">
                                ...
                                <div class="box box-solid">
                                    ...
                                    <div class="box-body">
                                        ...
                                        @if($schedule->isEmpty())
                                        @else
                                            <a href="{{ url('reports/' . $event_id . '/pdf') }}"
                                               title="Download PDF Schedule">
                                                @endif

                                                <button class="btn btn-success btn-small {{$schedule->isEmpty() ? 'disabled' : ''}}">
                                                                    ...
                                                                    @foreach($buyer as $bname)
                                                                        @if($bname->id === $inf->buyer_id)
                                                                            ...
                                                                            <li class="list-group-item">
                                                                                {{-- representatives  --}}
                                                                                <p> Repesentative
                                                                                    #1: {{ $bname->event_rep1 }}</p>
                                                                                <p> Repesentative
                                                                                    #2: {{ $bname->event_rep2 }}</p>
