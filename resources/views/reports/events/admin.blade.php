...
<div class="text-center">
    {{--<strong>Haranahsss-Phitex</strong>--}}
    {{--<hr>--}}
    {{--<h2>Schedules for <strong>{{$event->event_name}}</strong></h2>--}}
    ...
    <div class="row">
        ...
        <div class="col-xs-12 text-left">
            <ul class="no-bullet">
                                ...
                                @if($final_schedule->event_param_id == $event_param->id)
                                    <tr>
                                        ...
                                        @php
                                            $counter++;
                                        @endphp
                                        <td>{{date("H:i A", strtotime($event_param->start_time))}} - {{date("H:i A", strtotime($event_param->start_time))}}</td>
                                        <td>
                                            <strong>{{$final_schedule->buyer()->first()->user->name}}</strong>
                                            <br>
                                            <i>{{$final_schedule->buyer()->first()->company_name}}</i>
                                        </td>
                                        <td>{{$final_schedule->seller()->first()->company_name}}</td>
                                        <td><strong>{{$final_schedule->table}}</strong></td>
                                    </tr>
                                @endif
                ...
                {{--@foreach($event_params as $event_param)--}}
                {{--<tr>--}}
                {{--<td rowspan="{{$final_schedules->where('event_param_id', $event_param->id)->count()+1}}" colspan="2">{{date("H:i A", strtotime($event_param->start_time))}} - {{date("H:i A", strtotime($event_param->end_time))}}</td>--}}
                {{--</tr>--}}
                {{--@foreach($final_schedules as $final_schedule)--}}
                {{--@if($final_schedule->event_param_id == $event_param->id)--}}
                {{--<tr>--}}
